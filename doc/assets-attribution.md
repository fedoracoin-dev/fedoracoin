The following is a list of assets used in the fedoracoin source and their proper attribution.
...
* License: MIT
* Site: [https://fedoracointalk.org/index.php?topic=15276.0](https://fedoracointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original fedoracoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/fedoracoin.icns, src/qt/res/src/fedoracoin.svg,
	src/qt/res/src/fedoracoin.ico, src/qt/res/src/fedoracoin.png,
	src/qt/res/src/fedoracoin_testnet.png, docs/fedoracoin_logo_doxygen.png,
